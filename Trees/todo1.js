...
// let nodeF = new BTNode(12)
// let nodeA = new BTNode(22), nodeB = new BTNode(5), nodeC = new BTNode(44), nodeD = new BTNode(7), nodeE = new BTNode(18) 
// let nodeG = new BTNode(10), nodeH = new BTNode(2), nodeI = new BTNode(31), nodeJ = new BTNode(27), nodeK = new BTNode(6)
